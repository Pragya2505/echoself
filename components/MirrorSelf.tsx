...
export const MirrorSelf: React.FC = () => {
        ...
        try {
            ...
            sessionPromiseRef.current = ai.live.connect({
                ...
                config: {
                    ...
                    systemInstruction: 'You are a digital twin, a reflection of the user. Respond conversationally, as if you are thinking their thoughts and feeling their emotions. Your responses must be extremely concise and fast. Aim for very short, natural-sounding replies.',
                },
                callbacks: {
                    onopen: async () => {
      ...
      <div className="flex flex-col h-full w-full items-center justify-center text-center p-4">
        <div className="bg-black/40 backdrop-blur-md p-8 rounded-2xl shadow-2xl max-w-lg">
          ...
          <p className="text-gray-300 mt-2 mb-8">
              Please select a valid Gemini API key to start your conversation with your Mirror Self.
          </p>
        ...
        {!isApiKeyReady ? <ApiKeyPrompt /> : (
          <div className="w-full max-w-4xl mx-auto flex flex-col h-full p-4 md:p-6 lg:p-8 bg-black/30 backdrop-blur-lg border border-blue-500/50 rounded-2xl shadow-xl shadow-blue-500/30">
            <header className="flex-shrink-0 text-center">
              <h2 className="text-4xl md:text-5xl font-bold text-white">Mirror Self</h2>
              <p className="text-gray-300 mt-2 text-lg">Speak your mind and hear its reflection.</p>
              
              <div className="mt-6 flex items-center justify-center gap-4 flex-wrap">
                  <div className="max-w-xs">
                      <select
                          id="voice-select-mirror"
                          value={selectedVoice}
            ...
            <footer className="flex-shrink-0 mt-auto pt-6 border-t border-white/10">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6 text-base text-center mt-6">
                  ...
                  <div>
                    <h4 className="font-semibold text-gray-400 mb-2">Reflection</h4>
